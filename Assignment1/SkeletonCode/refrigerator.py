...
from applnlayer.ApplnMessageTypes import MessageTypes,milk_type,meat_type,bread_type,status_type,dispenser_type
...
class Refrigerator ():
  ...
  def gen_grocery_order_msg (self):
    ...
    groc_msg.veggie['cucumber'] = 1
    groc_msg.veggie['eggplant'] = 1
    groc_msg.veggie['tomato'] = 1
    groc_msg.veggie['potato'] = 1
    groc_msg.veggie['carrot'] = 1
    groc_msg.drinks['cans']['beer'] = 1
    groc_msg.drinks['cans']['coke'] = 1
    groc_msg.drinks['cans']['coffee'] = 1
    groc_msg.drinks['bottle']['sprite']  = 1
  ...
  def gen_health_status_msg (self):
    ...
    status_msg.icemaker = 1
    status_msg.fridge_temp = 10
    status_msg.freezer_temp = 20
