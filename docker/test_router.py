...
def driver (args):
  ...
  try:
    ...
    myaddr = route[args.demux_token]['myAddr']
    myport = route[args.demux_token]['myPort']
  ...
  try:
    ...
    nexthopaddr = route[args.demux_token]['addr']
    nexthopport = route[args.demux_token]['port']
